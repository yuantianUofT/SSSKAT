...
threshold_test <- function(Y, X, G, S, id.t, thre_value, wBurden = NULL, wSKAT = NULL, wACAT = NULL, mac.thresh = 10, testtype = "all") {
  ...
  if (testtype == "all") {
    ...
    obj.S <- SKAT_Null_Model(y ~ X, out_type="D", Adjustment = F)
    # SKAT results
